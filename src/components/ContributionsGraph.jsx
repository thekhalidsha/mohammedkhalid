...
const ContributionsGraph = () => {
    return (
        <section>
            <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 w-full">
                <p className='font-heading font-bold text-4xl text-zinc-700 pb-8'>Contribution Graph <small className='text-base'>(last-year)</small></p>
