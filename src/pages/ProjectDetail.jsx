                                ...
                                <div className="text-left flex flex-col border-b">
                                    <div className='flex justify-between py-2 mx-2'>
                                        ...
                                        <div className='flex gap-2 items-center justify-center'>
                                            <a target='_blank' href={selectedProject.github} className="h-10 w-10 font-medium flex justify-center items-center text-zinc-700 bg-zinc-100 hover:bg-zinc-300 focus:ring-2 focus:outline-none focus:ring-zinc-800 rounded text-sm text-center cursor-pointer">
                                                <SiGithub className='max-lg:size-4 size-5 ' />
                                            </a>
                                            <button onClick={toggleDetailModal} className='h-10 w-10 font-medium flex justify-center items-center text-zinc-700 bg-zinc-100 hover:bg-zinc-300 focus:ring-2 focus:outline-none focus:ring-zinc-800 rounded text-sm px-2 py-1 text-center cursor-pointer'>
